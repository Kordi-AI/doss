...
the raw vault or an existing directory Doss did not create. Regenerate after
changing `policy.yaml` or `local/access.yaml`; expired views can be removed with
`doss view cleanup --dir PARENT`.
