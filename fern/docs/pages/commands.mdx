---
description: Doss CLI reference for setup, connect, validation, sync, requester views, devices, hooks, and disclosure logging.
---
...
> **Warning:** `doss deactivate` blocks future Doss-managed GitHub sync when the
> device has recorded deploy-key metadata. It cannot erase an already cloned
...
- **Owners:** `init`, `devices`, `deactivate`, `doctor`, `tidy`, `uninstall`,
  and policy edits.
